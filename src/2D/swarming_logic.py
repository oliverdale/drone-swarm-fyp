        ...
        for i in range(len(drones) - 1):
            ...
            for n in range(len(drones) - i - 1):
                ...
                if i == 0:
                    ...
                    elif drone1.distance(drone2) > 9:
                        rospy.loginfo("WARNING: DRONE {} and DRONE {} FURTHER THAN 9M OF EACH OTHER".format(i,n+i+1))
                    ...
                    elif drone1.distance(drone2) > 16:
                        rospy.loginfo("WARNING: DRONE {} and DRONE {} FURTHER THAN 16M OF EACH OTHER".format(i,n+i+1))
                else:
                    if drone1.distance(drone2) < 3:
                        rospy.loginfo("ERROR: DRONES WITHIN 3M OF EACH OTHER")
                        formation = False
                        ...
                        rospy.loginfo("WARNING: DRONE {} and DRONE {} FURTHER THAN 12M OF EACH OTHER".format(i,n+i+1))
