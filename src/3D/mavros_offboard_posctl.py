...
class MultiMavrosOffboardPosctl(MultiMavrosCommon):
    ...
    def set_up(self, uav_id, field, is_local):
    ...
    def wait_for_offboard(self, timeout=None):
        ...
        self.reach_position(self.global_position.latitude, self.global_position.longitude) # dont specify alt to go to default alt
    ...
    def reach_position(self, lat, lon, alt=None):
        ...
        # print("Def, amsl: ", self.default_altitude, self.initial_amsl)
        # Print the current and commanded position
        # rospy.loginfo(
